...
export class UsersHanaRepository implements IUsersRepository {
  ...
  async update(
    ...
    if (dto.name !== undefined) {
      setParts.push('"U_NomUser" = ?');
      params.push(dto.name);
    }
    if (dto.supervisorName !== undefined) {
      setParts.push('"U_NomSup" = ?');
      params.push(dto.supervisorName);
    }
    if (dto.superUser !== undefined) {
      setParts.push('"U_SuperUser" = ?');
      params.push(dto.superUser);
    }
    if (dto.estado !== undefined) {
      setParts.push('"U_Estado" = ?');
      params.push(dto.estado);
    }
    if (dto.appRend !== undefined) {
      setParts.push('"U_AppRend" = ?');
      params.push(dto.appRend);
    }
    if (dto.appConf !== undefined) {
      setParts.push('"U_AppConf" = ?');
      params.push(dto.appConf);
    }
    if (dto.appExtB !== undefined) {
      setParts.push('"U_AppExtB" = ?');
      params.push(dto.appExtB);
    }
    if (dto.appUpLA !== undefined) {
      setParts.push('"U_AppUpLA" = ?');
      params.push(dto.appUpLA);
    }
    if (dto.genDocPre !== undefined) {
      setParts.push('"U_GenDocPre" = ?');
      params.push(dto.genDocPre);
    }
    if (dto.fijarNr !== undefined) {
      setParts.push('"U_FIJARNR" = ?');
      params.push(dto.fijarNr);
    }
    if (dto.nr1 !== undefined) {
      setParts.push('"U_NR1" = ?');
      params.push(dto.nr1);
    }
    if (dto.nr2 !== undefined) {
      setParts.push('"U_NR2" = ?');
      params.push(dto.nr2);
    }
    if (dto.nr3 !== undefined) {
      setParts.push('"U_NR3" = ?');
      params.push(dto.nr3);
    }
    if (dto.nr4 !== undefined) {
      setParts.push('"U_NR4" = ?');
      params.push(dto.nr4);
    }
    if (dto.nr5 !== undefined) {
      setParts.push('"U_NR5" = ?');
      params.push(dto.nr5);
    }
    if (dto.fijarSaldo !== undefined) {
      setParts.push('"U_FIJARSALDO" = ?');
      params.push(dto.fijarSaldo);
    }
    if (dto.fechaExpiracion !== undefined) {
      setParts.push('"U_FECHAEXPIRACION" = ?');
      params.push(dto.fechaExpiracion);
    }
    if (hashedPassword) {
